...
<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top affix-top">
 ...
 <!--   <li> <a href="company_details.jsp">Company Details</a> </li> -->
   ...
   <li class="btn btn-danger"> <a href="questions.jsp">Add questions</a> </li> 
        <li> <a href="index.jsp">Logout</a> </li>

      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div></nav><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
/* 		 String action = "addcompany_tbl";  */ 
 ...
 <TD> <a href="Eligiblestudents.jsp?company=<%=c.getString(2)%>&schcriteria=<%=c.getString(3)%>"><button type="button" class="btn btn-danger">Eligible Students</button></a></TD>
							 ...
							 <TD> <a href="modifycompschedule.jsp?company=<%=c.getString(2)%>&schcriteria=<%=c.getString(3)%>"><button type="button" class="btn btn-danger">Modify</button></a></TD>
       <%
       	}
       %>
            </TR>
