...
session.setAttribute("corseName",corseName);   --> 
<body>
...
<form action="StudentLoginController">
  ...
  <div class="container" style="background-color:#f1f1f1">
   <!--  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="cancelbtn">Cancel</button>&nbsp; -->
    <span class="psw">Forgot <a href="Studentforgotpass.jsp">password?</a></span>&nbsp
    <span class="psw">New<a href="StudentReg.jsp">Register here</a></span>
