...
System.out.println("session email exampage:" +email);
...
%>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
							...
							<a href="StudentHome.jsp"><h2>Logout</h2></a>
      </ul>
    </div>
...
if(sec==0){
    ...
    time--;
               ...
               <form id="myform" action="controller.jsp">
                       ...
                       ArrayList list=pDAO.getQuestions(request.getParameter("testtype"),10);
                      
                       Questions question;
                       %>
                       <input type="hidden" name="size" value="<%=list.size()%>">
                       <input type="hidden" name="totalmarks" value="<%=pDAO.getTotalMarksByName(request.getParameter("testtype"))%>">
           ...
           <div class="profile">
               ...
               <span class="tag">Test type</span><span class="val"><%=result.getTesttype()%></span><br/>
        ...
        %>
      <br> <br> <br> <br>
        <div class="panel form-style-6";max-width: 500px; padding-top: 40px;">
            <div class="title" style="margin-top: -60px;">Take Exam</div>
       <br/>
              ...
              <label>Select exam type</label>
                    <select class="form-control" id="sel1" name=testcategory>
           <!--   <option>Mock</option> -->
           ...
           <!--    <option>Technical</option> -->
                   ...
                   <input type="text" name="email" value="<%=session.getAttribute("email") %>" readonly required="">
