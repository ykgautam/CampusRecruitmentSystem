...
<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top affix-top">
 ...
 <div class="navbar-brand page-scroll anim_logo"><img src="images/LOGOF.png" alt=" Placement Cell" PLACEMENT CELL></div> </div>
   ...
   <li  class="active"> <a href="company_details.jsp">Company Details</a> </li>
   ...
   <li> <a href="viewstuddetails.jsp">Student Details</a> </li>
    ...
    <!-- /.navbar-collapse --> 
			...
			<center>
				<span style='font-weight: bold;'><h2>All Company</h2></span>
			</center>
		...
		%>
           <TR>
				...
				<%-- 			<TD><%=c.getString(9)%></TD> --%>
							<TD><%=c.getString(7)%></TD>
							<TD><%=c.getString(13)%></TD>
							<TD><%=c.getString(14)%></TD>
							<TD><%=c.getString(9)%></TD>
							<TD><%=c.getString(10)%></TD>
						<%-- 	<TD><%=c.getString(13)%></TD> --%>
			<%-- 				<TD><%=c.getString(14)%></TD>
							<TD><%=c.getString(15)%></TD> --%>
							<%-- <TD><%=c.getString(16)%></TD> --%>



							 <TD> <a href="modifycompany.jsp"><button type="button" class="btn btn-danger">Modify</button></a></TD>
       <%
       	}
       %>
            </TR>
